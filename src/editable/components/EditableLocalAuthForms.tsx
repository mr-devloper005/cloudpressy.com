...
const inputClass = 'h-[3.5rem] rounded-md border border-black/10 bg-white px-4 text-base font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-black/35 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.5rem] items-center justify-center rounded-md bg-[var(--slot4-dark-bg)] px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:bg-[var(--slot4-accent)] disabled:opacity-60'

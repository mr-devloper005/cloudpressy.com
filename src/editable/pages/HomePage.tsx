...
export default async function HomePage() {
  const primaryTask = (SITE_CONFIG.tasks.find((task) => task.key === 'mediaDistribution' && task.enabled)?.key || SITE_CONFIG.tasks.find((task) => task.enabled)?.key || 'mediaDistribution') as TaskKey
